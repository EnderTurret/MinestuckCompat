...
public final class MCGeneratedGristCostConfig extends GeneratedGristCostConfigProvider implements IGeneratedGristCostConfigProviderExtensions {
	...
	protected void addEntries() {
		...
		type(AllRecipeTypes.SEQUENCED_ASSEMBLY.getType(), new SequencedAssemblyInterpreter(EMPTY, grist(BUILD, 1), grist(MERCURY, 1), EMPTY, grist(RUST, 1)));
		...
		// Farmers Delight
		type(ModRecipeTypes.COOKING.get(), new CookingInterpreter(grist(IODINE, 1)));
