...
@Mixin(DesignixRecipeCategory.class)
public abstract class MixinDesignixRecipeCategory implements IRecipeCategory<JeiCombination> {

	@Override
	@Nullable
	public ResourceLocation getRegistryName(JeiCombination recipe) {
		return JeiHooks.getId(recipe, CombinationMode.OR);
	}
}